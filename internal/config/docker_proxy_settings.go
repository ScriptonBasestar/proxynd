...
// DockerProxySettings represents the configuration for Docker proxy settings
...
func (cfg *DockerProxySettings) ConfigExists() bool {
...
func (cfg *DockerProxySettings) ReadConfig() error {
	confDir := helpers.GetConfigDir()
...
func (cfg *DockerProxySettings) Validate() error {
