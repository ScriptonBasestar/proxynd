...
type BasicAuth struct {
	// MavenProxySettings is exported
	Username string `yaml:"username,omitempty"`
	Password string `yaml:"password,omitempty"`
	// MavenProxySettings is exported
}

// MavenProxySettings represents the configuration for mavenproxy settings
type MavenProxySettings struct {
...
func (cfg *MavenProxySettings) Validate() error {
	// 기본 필드 검증
	if cfg.Path == "" {
