...
func TestNewBatchManager(t *testing.T) {
	config := configpkg.WebhookBatchingConfig{
		Enabled:           true,
		MaxSize:           5,
		MaxWaitTime:       "2s",
		FlushInterval:     "10s",
